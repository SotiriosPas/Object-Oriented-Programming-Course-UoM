...
public class User {
	...
	protected ArrayList<Group> joinedgroups;
	protected ArrayList<Post> myposts;
	protected ArrayList<Post> frontpage;
	protected ArrayList<String> suggestedfriends;
	...
	public void createfrontpage() {
		frontpage.addAll(myposts);
		for(User friend : friends ) {
			frontpage.addAll(friend.myposts);
		}
		Collections.sort(frontpage, new UserComparator()); 
	}
	...
	public class UserComparator implements Comparator<Post> {
		@Override
